...
<div id="wrapper" class="wrapper clear">
    <div id="menu" class="menu-panel">
        <ul>
            ...
            <li @if(Request::segment(2)=='sizes') class="active" @endif><a href="{{web_url()}}/admin/sizes"><i class="fa pull-left fa-user-secret  "></i>Вед.размеров</a></li>
            <li @if(Request::segment(2)=='documents') class="active" @endif><a href="{{web_url()}}/admin/documents"><i class="fa pull-left fa-file"></i>Вед. приема документов</a></li>
            <li @if(Request::segment(2)=='money') class="active" @endif><a href="{{web_url()}}/admin/money"><i class="fa pull-left fa-money "></i>Вед. сбора денег</a></li>
            <li @if(Request::segment(2)=='phones') class="active" @endif><a href="{{web_url()}}/admin/phones"><i class="fa pull-left fa-mobile-phone "></i>Вед. телефонов родителей</a></li>
